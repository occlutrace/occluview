...
pub use edit_adapter::{
    ...
    fill_holes_in_mesh, invert_mesh_orientation, mesh_edit_buffers_from_mesh,
    mesh_from_edit_buffers_like, repair_mesh_in_mesh, selected_connected_components_in_mesh,
    CoreMeshEditResult, CoreMeshRepairResult,
};
